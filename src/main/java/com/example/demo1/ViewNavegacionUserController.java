...
public class ViewNavegacionUserController {
    ...
    void verPantallaPaquetes(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewPaquetesUser.fxml"));
            ...
            Stage currentStage = (Stage) paquetesButton.getScene().getWindow();
            currentStage.close();
    ...
    void verPantallaHoteles(ActionEvent event) {
        try {
            // Cargar la nueva ventana
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewHotelUser.fxml"));
            Parent root = loader.load();
            ...
            // Cerrar la ventana actual
            Stage currentStage = (Stage) hotelesButton.getScene().getWindow();
            currentStage.close();
    ...
    void verPantallaArticulos(ActionEvent event) {
        try {
            // Cargar la nueva ventana
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewArticuloUser.fxml"));
            Parent root = loader.load();
    ...
    void verPantallaVehiculo(ActionEvent event) {
        try {
            // Cargar la nueva ventana
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewAutomovilUser.fxml"));
            Parent root = loader.load();
